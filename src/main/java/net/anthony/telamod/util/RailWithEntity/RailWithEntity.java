...
public abstract class RailWithEntity extends AbstractRailBlock implements Waterloggable, BlockEntityProvider {
    protected RailWithEntity(AbstractBlock.Settings settings) {
        super(true, settings);
    }
